...
open class CssSubProperty() {
    fun get(parent : CssProperty, property: PropertyMetadata) : CssProperty = CssProperty(property.name.replace("_","-"), parent)
}
...
open class CssProperty(val propertyName: String, val propertyParent: CssProperty? = null) {
    ...
    fun Style.invoke(value: String)  = property(fullName(), value)
